...
- [Android Navigation Patterns](references/android-navigation.md) — Navigation Compose, bottom nav, drawers, rails, deep linking, nested navigation, animations
- [Jetpack Compose Components](references/compose-components.md) — Lists, forms, dialogs, bottom sheets, loading states, animations
- [Material 3 Theming](references/material3-theming.md) — Color system, typography, shapes, elevation, responsive design, foldable support
