...
### **Transformers Js Setup**
  #### **Description**
Set up Transformers.js for browser inference
  #### **When**
Running HuggingFace models in browser
  #### **Implementation**
...
Build RAG entirely in browser
  #### **When**
Need retrieval without server calls
  #### **Implementation**
...
React hooks for on-device AI
  #### **When**
Building React apps with local inference
  #### **Implementation**
...
---
  #### **Pattern**
Loading large models on mobile
  #### **Problem**
Mobile devices have limited memory
  #### **Solution**
Use smaller quantized models (1B-3B params) on mobile

---
  #### **Pattern**
Blocking main thread during inference
  #### **Problem**
UI freezes during model operations
  #### **Solution**
Use Web Workers for heavy inference tasks
...
Not all browsers/devices support WebGPU
  #### **Solution**
Check support and fallback to WASM

---
  #### **Pattern**
Not caching models
  #### **Problem**
Users re-download models every visit
  #### **Solution**
Enable browser caching and preload models

---
  #### **Pattern**
Using server-sized models
  #### **Problem**
8B+ models are too large for most browsers
  #### **Solution**
Use 1B-3B quantized models designed for edge
