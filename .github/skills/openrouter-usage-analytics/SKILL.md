...
- [Custom Analytics Implementation](references/custom-analytics-implementation.md) — UsageAnalytics class, model/time-series/user analytics
- [Performance Analytics](references/performance-analytics.md) — Latency analysis, error rate tracking
- [Dashboard Export](references/dashboard-export.md) — JSON/CSV report generation
